...
> **PDF com tudo (roteiro + comandos + prompts completos):**  
> `docs/manual-gravacao-completo.md` → exportar com `./scripts/export-manual-gravacao-pdf.sh`  
> Regenerar após editar prompts ou roteiro: `./scripts/generate-manual-gravacao.sh`
...
|-------|--------|------|-------|--------------|
| **1.1** | O desafio da eficiência operacional em cloud | **T** | 8–10 | Slides. `1.1-narrativa-abertura.md`. Sem terminal. |
| **1.2** | Entendendo comportamento de consumo em cloud | **T+** | 10–12 | Slides + comandos abaixo. `1.2-desperdicios-operacionais.md` *(opcional)*. |
| **1.3** | Identificando tendências de crescimento operacional | **T+** | 10–12 | Slides + Grafana. Opcional: business-hours 2 min antes. `1.3-padroes-sazonalidade.md`. |
| **1.4** | Alertas e visibilidade de custo orientados por contexto | **T+** | 10–12 | Slides + Grafana + menção Prometheus. `1.4-metricas-essenciais.md`. |
| **1.5** | **Hands-on — análise operacional de consumo** | **H** | 12–15 | Fluxo completo abaixo. `1.5-panorama-consumo.md`. |
...
3. Colar saída do `collect-lab-context.sh` em `ai-prompts/aula-01/1.5-panorama-consumo.md`
...
| Vídeo | Título | Tipo | Tempo | O que gravar |
|-------|--------|------|-------|--------------|
| **2.1** | O impacto do over-provisioning | **T** | 8–10 | Slides. Citar `payments-api`. `2.1-business-case-em.md`. |
| **2.2** | Rightsizing baseado em comportamento real | **T+** | 10–12 | Slides + dashboard Usage vs Requests. `2.2-rightsizing-payments-api.md`. |
| **2.3** | Ajustando recursos com automação | **T+** | 10–12 | Slides + `kubectl describe` opcional. `2.3-automacao-vpa.md`. |
| **2.4** | Scheduling inteligente e otimização | **T** | 10–12 | Slides. Citar `staging-api`. `2.4-comparativo-workloads.md` *(opcional)*. |
| **2.5** | **Hands-on — pipeline de rightsizing** | **H** | 12–15 | Fluxo completo abaixo. `2.5-rightsizing-hands-on.md`. |
...
3. Colar `collect-lab-context.sh` em `ai-prompts/aula-02/2.5-rightsizing-hands-on.md`
...
| Vídeo | Título | Tipo | Tempo | O que gravar |
|-------|--------|------|-------|--------------|
| **3.1** | Detectando comportamento anormal de consumo | **T+** | 8–10 | Slides + dashboard **sem** spike. `3.1-deteccao-anomalia-cpu.md`. |
| **3.2** | Investigando origem de anomalias | **T++** | 10–12 | Slides + ativar spike. `3.2-investigacao-anomalia-cpu.md`. |
| **3.3** | Planejamento operacional de capacidade | **T+** | 10–12 | Slides + Capacity Headroom. `3.3-capacity-planning.md`. |
| **3.4** | Otimizando uso de recursos em cloud | **T++** | 10–12 | Slides + anomalia silenciosa staging. `3.4-anomalia-silenciosa-staging.md`. |
| **3.5** | **Hands-on — anomalias e capacidade** | **H** | 12–15 | Fluxo completo abaixo. `3.5-runbook-anomalias.md`. |
...
3. Colar `collect-anomaly-context.sh` em `ai-prompts/aula-03/3.5-runbook-anomalias.md`
...
| Vídeo | Título | Tipo | Tempo | O que gravar |
|-------|--------|------|-------|--------------|
| **4.1** | Ownership e responsabilidade | **T+** | 8–10 | Slides + labels. `4.1-auditoria-labels.md`. |
| **4.2** | Classificação de recursos e ambientes | **T+** | 10–12 | Slides + Governance Matrix. `4.2-politica-ambientes.md`. |
| **4.3** | Alocação de custos por contexto | **T+** | 10–12 | Slides + Showback + OpenCost. `4.3-showback-chargeback.md`. |
| **4.4** | Guardrails e políticas | **T+** | 10–12 | Slides + Guardrails Checklist. `4.4-guardrails.md`. |
| **4.5** | **Hands-on — governança e custos** | **H** | 12–15 | Fluxo completo abaixo. `4.5-visibilidade-persona.md`. |
...
3. Colar `collect-lab-context.sh` em `ai-prompts/aula-04/4.5-visibilidade-persona.md`
...
| Vídeo | Título | Tipo | Tempo | O que gravar |
|-------|--------|------|-------|--------------|
| **5.1** | Custo × performance × observabilidade | **T+** | 8–10 | Slides + tour rápido nos 4 dashboards. `5.1-diagnostico-consolidado.md`. |
| **5.2** | Tomada de decisão orientada por dados | **T** | 10–12 | Slides + matriz impacto×esforço. `5.2-priorizacao-matriz.md`. |
| **5.3** | Eficiência contínua (90 dias) | **T** | 10–12 | Slides. `5.3-plano-90-dias.md`. Sem lab. |
| **5.4** | Cultura orientada por eficiência | **T** | 10–12 | Slides de fechamento. `5.4-recomendacoes-executivas.md`. |
| **5.5** | **Hands-on — fluxo completo FinOps com IA** | **H** | 12–15 | Fluxo end-to-end abaixo. `5.5-copiloto-eficiencia.md` *(mestre)*. |
...
4. Colar `collect-lab-context.sh` em `ai-prompts/aula-05/5.5-copiloto-eficiencia.md`
...
| Arquivo | Conteúdo |
|---------|----------|
| `docs/manual-gravacao-completo.md` | **Manual completo** — roteiro + prompts (exportar PDF) |
